...
public:
	...
	TObjectPtr<UVrmMetaObject> MetaObject;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Rendering)
	TObjectPtr<USkeleton> BaseSkeleton;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Tracking)
	TObjectPtr<USceneComponent> ComponentHandLeft;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Tracking)
	TObjectPtr<USceneComponent> ComponentHandRight;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Tracking)
	TObjectPtr<USceneComponent> ComponentHead;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Tracking)
		TObjectPtr<USceneComponent> ComponentHandJointTargetLeft;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Tracking)
		TObjectPtr<USceneComponent> ComponentHandJointTargetRight;
