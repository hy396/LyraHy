...
public:
	...
	TObjectPtr<USkeletalMeshComponent> SrcSkeletalMeshComponent;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Rendering)
	TObjectPtr<USkinnedMeshComponent> SrcAsSkinnedMeshComponent;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Rendering)
	TObjectPtr<UVrmAssetListObject> SrcVrmAssetList;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Rendering)
	TObjectPtr<UVrmMetaObject> SrcVrmMetaOverride;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Rendering)
	TObjectPtr<UVrmAssetListObject> DstVrmAssetList;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Rendering)
	TObjectPtr<UVrmMetaObject> DstVrmMetaForCustomSpring;
