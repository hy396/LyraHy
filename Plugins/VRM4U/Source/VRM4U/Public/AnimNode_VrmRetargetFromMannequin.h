...
struct VRM4U_API FAnimNode_VrmRetargetFromMannequin : public FAnimNode_SkeletalControlBase
{
	...
	TObjectPtr<UVrmMetaObject> VrmMetaObject = nullptr;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Skeleton, meta = (PinHiddenByDefault))
	TObjectPtr<UVrmMetaObject> MannequinVrmMetaObject = nullptr;

	FAnimNode_VrmRetargetFromMannequin();

	UPROPERTY()
	TObjectPtr<USkeletalMesh> srcSkeletalMesh = nullptr;
	UPROPERTY()
	TObjectPtr<USkeletalMesh> dstSkeletalMesh = nullptr;
