...
EDataValidationResult ULyraGameplayAbility_FromEquipment::IsDataValid(FDataValidationContext& Context) const
{
	...
	// EGameplayAbilityInstancingPolicy::NonInstanced is deprecated in UE 5.6, so check for the
	// instanced policies instead.
	const bool bIsInstanced = (InstancingPolicy == EGameplayAbilityInstancingPolicy::InstancedPerActor)
