...
// 初始化：从 ASC 上取 HealthSet，订阅 Health / MaxHealth 的属性变化与血量归零事件
...
// 客户端收到死亡状态变化：补发死亡开始/结束事件，保证客户端流程一致
...
// 启动死亡：置 DeathStarted、加死亡标签、广播 OnDeathStarted
...
// 结束死亡：置 DeathFinished、广播 OnDeathFinished
